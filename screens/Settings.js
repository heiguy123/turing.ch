      ...
      <View style={styles.container}>
        <View style={styles.textcontainer}>
          ...
          <View style={styles.title2}>
            <Text style={fonts.h4}>Default Temperature Unit</Text>
            <Text style={fonts.p}>
              Celcius {"\n"}
              {"\n"}
              {"\n"}
            </Text>
            <Text style={fonts.h4}>Default Precipitation Unit</Text>
            <Text style={fonts.p}>
              mm {"\n"}
              {"\n"}
              {"\n"}
            </Text>
            <Text style={fonts.h4}>Default Solar Irradiance Unit</Text>
            <Text style={fonts.p}>
              kW-hr/m^2/day {"\n"}
              {"\n"}
              {"\n"}
            ...
            >
              <Text style={styles.reseth1}>Reset to Default</Text>
            </TouchableHighlight>
            ...
            >
              ...
              >
                <Text style={styles.reseth2}>Team Leader:</Text>
                <Text style={styles.reseth3}>Moses Lau Yi Hieng{"\n"}</Text>
                <Text style={styles.reseth2}>Team Members:</Text>
            ...
            <TouchableOpacity onPress={() => setModalVisible(true)}>
              <Text style={fonts.h4}>Contributors</Text>
              <Text style={fonts.p}>
        ...
        <View style={[styles.row, { paddingTop: "5%", paddingBottom: "16%" }]}>
          ...
          >
            ...
            >
              ...
              />
              <Text style={[fonts.p, { marginBottom: 5 }]}>Settings</Text>
...
const styles = StyleSheet.create({
  ...
  title1: {
    top: Dimensions.get("window").height * 0.06 + sbspace,
  },
  title2: {
    flex: 0.8,
